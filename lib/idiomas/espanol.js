...
const smsResultPareja = () => { return No tiene Pareja Por Bot}
const smsSaludo = () => { return 👋 !HOLA! BIENVENIDO(A) 🌟}
const smsDia = () => { return 🌇 Buenos Días Bellezas ⛅}
const smsTarde = () => { return 🏙 Buenas Tardes Linduras 🌤}
const smsTarde2 = () => { return 🌆 Buenas tardes Soltero es/as 🌥}
const smsNoche = () => { return 🌃 Buenas noches 💫}
const smsListaMenu = () => { return ⊹ LISTA DE MENU ⊹}
const smsLista1 = () => { return 🌟 INFORMACIÓN DE BOT-KITTY 🌟}
...
const smsLista7 = () => { return 🎀 INSTALAR BOT-KITTY 🎀}
...
const smsBye = () => { return '╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰\n┊ @user\n┊ UN MANCO/CA MENOS EN EL GRUPO, CHAO!! 😎\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
const smsCont2 = () => { return *⚠ 𝗣𝗟𝗨𝗚𝗜𝗡:*}
const smsCont3 = () => { return *⚠ 𝗨𝗦𝗨𝗔𝗥𝗜𝗢:*}
const smsCont4 = () => { return *⚠ 𝗖𝗢𝗠𝗔𝗡𝗗𝗢:*}
const smsCont5 = () => { return *⚠ 𝗘𝗥𝗥𝗢𝗥:*}
...
const smsCont9 = () => { return ${global.lenguajeGB['smsAvisoAG']()}*NECESITA EL NIVEL ➡*}
const smsCont10 = () => { return *PARA USAR ESTE COMANDO. TÚ NIVEL ACTUAL ES ➡*}
...
const eGataCoins = () => { return '🐱 KittyCoins' }
...
const eCuerda = () => { return '🕸 Cuerda' }
const eHierro = () => { return '⛓ Hierro' }
const eCarbon = () => { return '⚱ Carbón' }
const eBotella = () => { return '🍶 Botella' }
const eLata = () => { return '🥫 Lata' }
const eCarton = () => { return '🪧 Cartón' } 
const eEletric = () => { return '💡 Electricidad' }
const eBarraOro = () => { return '〽 Barra de Oro' }
const eOroComun = () => { return '🧭 Oro Común' }
const eZorroG = () => { return '🦊🌫 Zorro Grande' }
const eBasuraG = () => { return '🗑🌫 Super Basura' }
const eLoboG = () => { return '🐺🌫 Super Lobo' }
const eMaderaG = () => { return '🛷🌫 Super Madera' }
const eEspada = () => { return '⚔ Espada' }
...
const eCMistica = () => { return '🗳 Caja Mítica' }
...
const eCFenix = () => { return '🕊🥩 Comida de Fénix' } 
...
const smsModAd2 = () => { return Solo los Admins podrán usar KittyBot en Grupos}
